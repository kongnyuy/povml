...
fragmented_db_factored <- fragmented_db %>% mutate(
  hv202 = as.factor(hv202)
)



View(head(fragmented_db))


# adjust values in dhs dataset to match gadm shape naming conventi --------
