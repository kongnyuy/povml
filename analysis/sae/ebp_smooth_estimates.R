...
#save the base data set to simplify documentation
saveRDS(datc, file = "data/processed/admin321_covariates.rds")
...
patchwork::wrap_plots(cmp_plots2, nrow = 10, ncol = 3)
...
save(mdat.smooth.wealthscore_mean, mdat.smooth.gini, mdat.smooth.headcount, mdat.smooth.povgap, file = "data/processed/out/mdat.smooth.admin3.resulst.RData")
